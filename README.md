...
[![Build Status](https://github.com/djienet/kratos/workflows/Go/badge.svg)](https://github.com/djienet/kratos/actions)
[![GoDoc](https://godoc.org/github.com/djienet/kratos?status.svg)](https://godoc.org/github.com/djienet/kratos)
[![Go Report Card](https://goreportcard.com/badge/github.com/djienet/kratos)](https://goreportcard.com/report/github.com/djienet/kratos)
...
### Installation
```shell
GO111MODULE=on && go get -u github.com/djienet/kratos/tool/kratos
cd $GOPATH/src
kratos new kratos-demo
```

通过 `kratos new` 会快速生成基于kratos库的脚手架代码，如生成 [kratos-demo](https://github.com/djienet/kratos-demo) 
